...
<head>
  ...
  <link href="<?php echo base_url('assets/sitio/assets/img/03.png');?>" rel="apple-touch-icon">
...
<body>
          ...
          <div class="row justify-content-center">
            ...
            <div class="d-flex justify-content-center py-4">
                <a href="<?php echo base_url(); ?>" class="logo d-flex align-items-center w-auto">
                  <img src="<?php echo base_url() . 'assets/administrador/img/logo.png'; ?>" />
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Sesion para Administracion</h5>
                    <p class="text-center small">Ingrese su nombre de usuario y contraseña para iniciar sesión</p>
                  </div>

                  <form class="row g-3 needs-validation" action="<?php echo base_url() . 'iniciar-sesion-admin/verificacion'; ?>" method="post">
                  ...
                  <br>
                  <!--<div class="col-12">
                    <p class="small mb-0">¿No tienes cuenta? <a href="<?php echo base_url() . 'registrar-admin'; ?>">Crea una cuenta</a></p>
                  </div>-->
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url('assets/administrador/vendor/apexcharts/apexcharts.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/bootstrap/js/bootstrap.bundle.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/chart.js/chart.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/echarts/echarts.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/quill/quill.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/simple-datatables/simple-datatables.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/tinymce/tinymce.min.js');?>"></script>
  <script src="<?php echo base_url('assets/administrador/vendor/php-email-form/validate.js');?>"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo base_url('assets/administrador/js/main.js');?>"></script>
