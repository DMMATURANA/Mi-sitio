            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Sesion para Usuarios</h5>
                    <p class="text-center small">Ingrese su nombre de usuario y contraseña para iniciar sesión</p>
                  </div>

                  <form class="row g-3 needs-validation" action="<?php echo base_url() . 'iniciar-sesion-usuario/verificacion'; ?>" method="post">

                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Nombre de usuario</label>
                      <input type="text" name="username" class="form-control" required>
                      <div class="invalid-feedback">¡Debes ingresar el nombre de usuario!</div>
                    </div>
                  ...
                  <br>
                  <div class="col-12">
                    <p class="small mb-0">¿No tienes cuenta? <a href="<?php echo base_url() . 'registrar-usuario'; ?>">Crea una cuenta</a></p>
                  </div>
                  <br>
                  <div class="col-12">
                     <p class="small mb-0">¿Eres adminstrado? <a href="<?php echo base_url() . 'iniciar-sesion-admin'; ?>">Accede al panel de control</a></p>
                  </div>
