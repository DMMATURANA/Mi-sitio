            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="<?php echo base_url() . 'registrar-usuario/reg-guardar'; ?>" class="row g-3 needs-validation" method="post">
                  ...
                  <br>
                  <div class="col-12">
                    <p class="small mb-0">¿Ya tienes una cuenta? <a href="<?php echo base_url() . 'iniciar-sesion-usuario'; ?>">Iniciar sesión</a></p>
                  </div>
